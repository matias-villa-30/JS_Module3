...
for (let i = 0; i < picArray.length; i++) {
  ...
  let article_head = document.createElement("h2");
  article_head.textContent = picArray[i].title;
  ...
  description.textContent = picArray[i].description;

  article.appendChild(article_head);
